...
namespace GestionDrivApi.Data
{
    ...
    {     
        public async static Task Initialize(ApplicationContext context)
        {
            ...
            {
                pd1 = new Product { Nom = "LACTEL : Lait demi-écrémé UHT", 
                                    Description = "APRÈS OUVERTURE, À CONSERVER AU FROID (6°C MAX) ET À CONSOMMER RAPIDEMENT (SOUS 3 JOURS)", 
                                    Quantity_stock = 100, 
                                    Category = c3,   
                                    Disponible = true };
                pd2 = new Product { Nom = "ELLE&VIRE : Crème fraîche épaisse entière 30% M.G", 
                                    ...
                                    Category = c3, 
                                    Disponible = true };
                pd3 = new Product { Nom = "YAOS : Yaourts à la grecque nature", 
                                    Description = "A CONSERVER AU FRAIS À MAX. +6°C", 
                                    Quantity_stock = 100, 
                                    Category = c3, 
                                    Disponible = true };
                pd4 = new Product { Nom = "POMME : Pink Lady", 
                                    Description = "Pommes Pinkids, ARFUMÉE, CROQUANTE ET SUCRÉE, variété Crisp Pink, calibre 115-150g.", 
                                    Quantity_stock = 100, 
                                    Category = c5, 
                                    Disponible = true };
                pd5 = new Product { Nom = "POMME DE TERRE : Pommes de terre de consommation", 
                                    ...
                                    Category = c4, 
                                    Disponible = true };
                pd6 = new Product { Nom = "LE GAULOIS : 4 à 5 filets de poulet blanc", 
                                    ...
                                    Category = c6, 
                                    Disponible = true };
                pd7 = new Product { Nom = "CHARAL : Onglet moelleux", 

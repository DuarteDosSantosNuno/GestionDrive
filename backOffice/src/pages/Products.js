...
export default class Products extends Component {
  ...
  componentDidMount() {
    ...
    axios.get("https://localhost:44329/api/v1/Product").then((response) =>
      this.setState({
        apiResponse: response.data,
      })
    );

    axios.get("https://localhost:44329/api/v1/Category").then((response) =>
      this.setState({
        ...
        <div className="ProductHeader d-flex bg-primary">
          ...
          <div className="">
            <MDBTooltip
              tag="button"
              wrapperProps={{
                className: "Button bg-white text-info",
                ...
                <MDBModalContent>
                  ...
                  <MDBModalBody className="text-start">
                    <form>
                      ...
                      <input
                        className="d-flex w-75 border-info rounded form-control"
                        id="name"
                        name="name"
                        type="text"
                      />
                      ...
                      <input
                        className="d-flex w-25 border-info rounded form-control"
                        id="quantity"
                        name="quantity"
                        type="number"
                      />
                      ...
                      <select
                        class="form-select w-25 border-info rounded form-control"
                        id="category"
                      >
                      ...
                      <input
                        className=" border-info rounded m-2"
                        name="available"
                        type="radio"
                        value="true"
                      />
                      ...
                      <div className="d-flex justify-content-center">
                        <MDBBtn
                          color="success"
                          tag="button"
                          wrapperProps={{ type: "submit", className: "" }}
                        >
                          Envoyer
                        </MDBBtn>
                      </div>
